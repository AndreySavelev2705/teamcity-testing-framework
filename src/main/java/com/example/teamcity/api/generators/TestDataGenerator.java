...
public final class TestDataGenerator {
     ...
     *
     * @param generatedModels список сгенерированных моделей для использования при генерации
     * @param generatorClass тип модели, который должен быть в итоге сгенерирован
     * @param parameters  параметры, которые могут быть использованы для задания конкретных значений полей объекта,
     *                   если эти поля имеют аннотацию @Parametrizable
    ...
    /**
     * Метод генерирует тестовые данные для класса TestData/
     *
     * @return экземпляр TestData со сгенерированными данными.
     */
     ...
     *
     * @param generatorClass класс модели, которую нужно сгенерировать и вернуть.
     * @param parameters  параметры, которые могут быть использованы для задания конкретных значений полей объекта,
     *                   если эти поля имеют аннотацию @Parametrizable
     * @return сгенерированная модель
     * @param <T> тип модели
