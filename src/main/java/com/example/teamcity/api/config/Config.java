...
/**
 * Класс, который хранит в себе конфигурацию проекта.
 *
...
public class Config {
    ...
    /**
     * Метод возвращает значение настройки по ее ключу из файла config.properties.
     *
     * @param key ключ по которому ищется настройка.
